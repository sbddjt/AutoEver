...
* 작성해드린 내용을 `README.md` 파일로 저장하신 후, GitHub 리포지토리에 푸시하시면 됩니다.
* **"디렉토리 구조에 맞춰서 실제로 폴더를 만들고, 오늘 정리한 내용을 각 폴더에 마크다운 파일로 저장하는 방법"**을 알려드릴까요? (예: `01_intro/installation_guide.md`)
